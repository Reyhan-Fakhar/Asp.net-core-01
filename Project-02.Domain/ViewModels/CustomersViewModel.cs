...
{
    public class CustomerCreateRequestViewModel
    {
    ...
    public class CustomerEditRequestViewModel
    {
        public long CustomerId { get; set; }
        [Display(Name = "نام مشتری")]
        [Required(ErrorMessage = "لطفا {0} را وارد کنید")]
    ...
    public class CustomerDetailsResultViewModel
    {
        public long CustomerId { get; set; }
        [Display(Name = "نام مشتری")]
        public string FullName { get; set; }
        ...
        [Display(Name = "درخواست های مشتری")]
        public List<Request> CustomerRequests { get; set; }
    }
}
